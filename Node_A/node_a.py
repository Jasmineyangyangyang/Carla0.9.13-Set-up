...
def main():
    ...
    world = client.load_world('Bend03')
    ...
    gameDisplay = pygame.display.set_mode((image_w,image_h), pygame.HWSURFACE | pygame.DOUBLEBUF) # 硬件加速显示， 双缓冲技术避免画面撕裂，pygame2.0.0以上没有用
